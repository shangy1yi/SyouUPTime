const pageConfig = {
  ...
  links: [
    { link: 'https://home.syou1ti.lol', label: '个人主页', highlight: true },
    { link: 'https://blog.syou1ti.lol', label: 'Blog', highlight: true },
    { link: 'mailto:dianeidelozierx@gmial.com', label: 'Email Me', highlight: true },
  ],
}
